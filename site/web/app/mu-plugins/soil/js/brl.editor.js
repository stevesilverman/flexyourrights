	...
	var switchBRLEditors = {
		...
		go : function(id, mode) {
			id = id;
			mode = mode || this.mode || '';
			//var ed, H = this.I('edBrlButtonHTML'), P = this.I('edBrlPreview'), ta = this.I(id);
			var ed, ta = this.I(id);

			var H = jQuery("[id^='"+id+"-'] .edBrlButtonHTML:first")[0];
			var P = jQuery("[id^='"+id+"-'] .edBrlPreview:first")[0];
