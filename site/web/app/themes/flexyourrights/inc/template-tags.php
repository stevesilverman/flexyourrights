...
function roots_entry_meta() {
  ...
  if (!is_front_page()) {
    ...
    echo '<div class="share share-facebook"><iframe src="https://www.facebook.com/plugins/like.php?href='. $url .'&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;action=like&amp;colorscheme=light&amp;font&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:20px;" allowTransparency="true"></iframe></div>';
    echo '<div class="share share-twitter"><iframe allowtransparency="true" frameborder="0" scrolling="no" src="https://platform.twitter.com/widgets/tweet_button.html?url='. $url .'&text='. $title .'&count=horizontal&via=flexyourrights&related=flexyourrights" style="width:110px; height:20px;"></iframe></div>';
    echo '<div class="share share-reddit"><script src="https://www.reddit.com/buttonlite.js?i=2&url='. $url .'"></script></div>';
    echo '</div>';
  }
